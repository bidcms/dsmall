...
class Buyvirtual {
    ...
    private function _createOrder($input, $goods_info, $member_info) {
        ...
        if ($goods_info['goods_storage_alarm'] >= ($goods_info['goods_storage'] - $input['quantity'])) {
            ...
            \mall\queue\QueueClient::push('sendStoremsg', array('code' => 'goods_storage_alarm', 'store_id' => $goods_info['store_id'], 'param' => $param, 'ali_param' => $param, 'ten_param' => $ten_param, 'weixin_param' => $weixin_param));
        }
